"""
MLP activations similarity under the following settings:
...
from utils.general_utils import (
    ...
    take_activation_similarities_with_edit_activation,
    lineplot_activation_sim,
)
...
if __name__ == "__main__":
    ...
    example usage:
    python -m analysis.representation_similarity.act_sim \
        ...
        --save_path_intervention figs/act_sim/type1_deactivated_ja \
        --save_path_baseline figs/act_sim/baseline_deactivated_ja
    """
    ...
    print(f'\nCollecting MLP activations with top-n transfer neurons deactivated.')
    similarities_same_semantics = take_activation_similarities_with_edit_activation(model, tokenizer, device, neurons, parallel_sentence_pairs)
    similarities_non_same_semantics = take_activation_similarities_with_edit_activation(model, tokenizer, device, neurons, non_parallel_sentence_pairs) 
    lineplot_activation_sim(similarities_same_semantics, similarities_non_same_semantics, lang, save_path_intervention) # visualization.
    
    # hs similarity with baseline neurons deactivated.
    print(f'\nCollecting MLP activations with randon n. neurons deactivated.')
    similarities_same_semantics = take_activation_similarities_with_edit_activation(model, tokenizer, device, random_neurons, parallel_sentence_pairs)
    similarities_non_same_semantics = take_activation_similarities_with_edit_activation(model, tokenizer, device, random_neurons, non_parallel_sentence_pairs) 
    lineplot_activation_sim(similarities_same_semantics, similarities_non_same_semantics, lang, save_path_baseline) 
