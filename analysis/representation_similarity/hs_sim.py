...
if __name__ == "__main__":
    ...
    parser.add_argument('--non_parallel_sentences_path', type=str, required=True, help='Path to parallel sentence pairs(in the paper, we sampled 1k english-L2 non-paralles sentence pairs from tatoeba curpus).')
